...
% concrete effect
\newcommand{\conEf}[2] { \llbracket #1 \rrbracket \; #2 }
\newcommand{\conEfT}[2] { \conEf{\text{#1}}{#2} }

% abstract effect
\newcommand{\absEf}[2] { \llbracket #1 \rrbracket^\sharp \; #2 }
\newcommand{\absEfT}[2] { \absEf{\text{#1}}{#2} }