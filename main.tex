...
The basic structure of the specification format is modeled after the DOT graph description language (\refListing{example.dot} would yield the graph shown in \refFigure{dot-example}).
