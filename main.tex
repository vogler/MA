...
The abstract state of the actual implementation is different because it uses Must- and May-Sets for states and outputs warnings directly, but the idea is similar.
